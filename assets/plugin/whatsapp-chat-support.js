 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        popupFx                     :   '10', // The popup effect from 0 till 14
        ...
        notAvailableMsg             :   'Hola, por el momento estamos fuera de servicio', // message when its not an available day or once the available hours have passed
        almostAvailableMsg          :   'Hola, en breve estaremos en línea', // if today is an available day and before the time starts
        dialogNotAvailableMsg       :   'Hola, por el momento estamos fuera de servicio', // message when its not an available day or once the available hours have passed
        dialogAlmostAvailableMsg    :   'Hola, en breve estaremos en línea', // if today is an available day and before the time starts
        defaultMsg                  :   'Hola, ¡Me gustaría agendar una cita!', // default support msg     
